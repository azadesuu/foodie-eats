...
function MyTheme(props) {
  ...
  const [currTheme, setcurrTheme] = useState({
    ...
    themes: ["honeydew", "dragonfruit",  "shokupan", "boring", "blueberry"]
  });
  ...
  const updateTheme = async theme => {
    setcurrTheme({ ...currTheme, activeTheme: currTheme.themes[theme]});
      try {
  ...
  const toggleActiveTheme = async theme => {
    if (currTheme.themes[theme] === currTheme.activeTheme) {
      return "active-theme";
    } else {
    ...
    <div>
      {userId ? (
        <div className="themes">
          <button className={toggleActiveTheme("honeydew")} value="honeydew" onClick={() => updateTheme("honeydew")}>
            <img id="honeydew" src={HoneyDew} />
          </button>
          <button className={toggleActiveTheme("dragonfruit")} value="dragonfruit" onClick={() => updateTheme("dragonfruit")}>
            <img id="dragonfruit" src={Dragonfruit} />
          </button>  
          <button className={toggleActiveTheme("shokupan")} value="shokupan" onClick={() => updateTheme("shokupan")}>
            <img id="shokupan" src={Shokupan} />
          </button> 
          <button className={toggleActiveTheme("boring")} value="boring" onClick={() => updateTheme("boring")}>
            <img id="boring" src={Boring} />
          </button>
          <button className={toggleActiveTheme("blueberry")} value="blueberry" onClick={() => updateTheme("blueberry")}>
