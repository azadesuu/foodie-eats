...
/**
 * @api {GET} /getReviewsByRecent Gets reviews sorted by recent from the MongoDB database
...
/**
 * @api {GET} /getReviewsByLikes Gets reviews sorted by likes from the MongoDB database
...
/**
 * @api {GET} /getReview/:reviewIds Gets one review by reviewId from the MongoDB database
...
/**
 * @api {PUT} /createReview Createsreview in the  MongoDB database
...
/**
 * @api {Patch} /updateReview Updates the review in the  MongoDB database
...
/**
 * @api {PUT} /like/:userId/:reviewId Likes a review in the  MongoDB database
